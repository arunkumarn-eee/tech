---
title: 'Interfacing 16x2 I2C LCD display with Arduino Uno'
description: Learn how to connect a 16x2 I2C LCD display to a Arduino Uno using simple Arduino code. This easy guide shows you how to set it up and display messages step by step.
authors:
  -
    name: Arun kumar N
...
# prefer light image
banner_image : assets/blogs/arduino-uno/16x2-I2C-lcd-display.png
tags:
  - arduino uno
  - arduino
  - cpp
...
![16x2 lcd](./../../../assets/blogs/arduino-uno/16x2-I2C-lcd-display.png)
...
![Circuit Diagram](./images/16x2_i2c_arduino_uno_ckt.png)
/// caption
...
<iframe style="height:calc(100vh - 200px); border-color:#00aaff;border-radius:1rem;min-height:400px" src="https://wokwi.com/projects/450769482757746689" frameborder="2px" width="100%" height="700px"></iframe>
