---
title: 'Interfacing 128x64 Monochrome OLED (SSD1306) with Arduino Nano'
description: Learn how to connect a 16x2 LCD display to a Arduino Nano using simple Arduino code. This easy guide shows you how to set it up and display messages step by step.
authors:
  -
    name: Arun kumar N
...
# prefer light image
banner_image : assets/blogs/arduino-nano/oled-display.png
tags:
  - arduino nano
  - arduino
  - cpp
...
![16x2 lcd](./../../../assets/blogs/arduino-nano/oled-display.png)
...
| ------------ | -------------------------------------------- | -------- | -------------------------------------------- |
| Arduino Nano | ATmega328P                                   | 1        | [Buy Here](https://www.skilldisk.com/category/all-products) |
...
| USB Cable    | Mini USB / Micro USB (depends on Nano model) | 1        | [Buy Here](https://www.skilldisk.com/category/all-products)    |
...
📌 **Why Use OLED with Arduino Nano?**
...
## 🧷 Connection / Wiring Guide (Arduino Nano to OLED)

Arduino Nano uses dedicated I2C pins:

* **A4 = SDA**
* **A5 = SCL**

### 🔥 Arduino Nano to OLED Pin Mapping

| OLED Pin | Arduino Nano Pin | Description  |
| -------- | ---------------- | ------------ |
...
![Circuit Diagram](./images/ckt_oled_nano.png)
/// caption
...
<iframe style="height:calc(100vh - 200px); border-color:#00aaff;border-radius:1rem;min-height:400px" src="https://wokwi.com/projects/453864129051933697" frameborder="2px" width="100%" height="700px"></iframe>
...
* Arduino Nano I2C logic is 5V, but most OLED modules tolerate it due to onboard resistors/regulator.
...
You have successfully interfaced a **128x64 SSD1306 OLED display** with an **Arduino Nano** using the **Arduino IDE** 🎉. Now you can build interactive projects like sensor dashboards, mini clocks, counters, and IoT displays. OLED modules are simple to use but add a professional look to any Arduino project.
pare an **OLED Dashboard UI code** (battery + sensor layout + custom icons) specially designed for Arduino Nano projects 😄
